...
def build_export_excel():
    ...
    route_strings = []   # list of (origin, route_str)
    ...
    # Sort output: 3322 rows first, then 3943
    ...
    # Build route column — 3322 trucks at rows 0…n, 3943 trucks starting at first 3943 row
    ...
    # Persist routes to history (once per week per origin)
    for origin in ['3322', '3943']:
        ...
        if any(t['stops'] for t in trucks):
            ...
            for truck in trucks:
                ...
                try:
                    ...
                    pass
                st.write(
                    f"• {build_route_string(truck['truck_number'], truck['stops'], rate_val)}"
                )
